        ...
        <FormGroup className={classes.groupForm} row>
          <Grid item md={4} xs={12}>
            <FormControlLabel
              ...
              label="1. NÃO CONSEGUE BEBER OU MAMAR NO PEITO"
            />
          </Grid>
          ...
          <Grid item md={4} xs={12}>
            <FormControlLabel
              ...
              label="2. LETÁRGICA OU INCONSCIENTE"
            />
          </Grid>
          ...
          <Grid item md={4} xs={12}>
            <FormControlLabel
              ...
              label="3. BATIMENTOS DE ASAS DO NARIZ/GEMENCIA"
            />
          </Grid>
          ...
          <Grid item md={4} xs={12}>
            <FormControlLabel
              ...
              label="4. TEMPO DE ENCHIMENTO CAPILAR  > 2 segundos"
            />
          </Grid>
          ...
          <Grid item md={4} xs={12}>
            <FormControlLabel
              ...
              label="5. CONVULSÕES/MOV. ANORMAIS"
            />
          </Grid>
